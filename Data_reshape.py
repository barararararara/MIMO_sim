...
for d in range(5, 31, 5):  # d = 5, 10, ..., 30
    Scatter1 = np.load(f"C:/Users/tai20/Downloads/sim_data/Data/{Method}/{channel_type}/Ssub={Ssub_lam}lam/Scatter1/d={d}/Scatter1.npy", allow_pickle=True)
    N = []
    M = []
    M_flat = []
    idx=0
    ...
    # 保存先ディレクトリ作成
    save_dir = f"C:/Users/tai20/Downloads/sim_data/Data/Mirror/{channel_type}/Ssub={Ssub_lam}lam/Scatter1/d={d}/Flattened"
